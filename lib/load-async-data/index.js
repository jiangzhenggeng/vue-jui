...
var _loadAsyncData = __webpack_require__(112);
...
var _LoadAsyncData = {
  install: function install() {
    Vue.component(_loadAsyncData2.default.name, _loadAsyncData2.default);
  }
};
exports.default = _LoadAsyncData;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_load_async_data_vue__ = __webpack_require__(114);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_b2deb5f4_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_load_async_data_vue__ = __webpack_require__(115);
...
/* scopeId */
var __vue_scopeId__ = "data-v-b2deb5f4"
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_b2deb5f4_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_load_async_data_vue__["a" /* default */],
...
exports.default = {
  ...
  mounted: function mounted() {
    ...
    var cache_data = _juiTools2.default.sessionStorage.get(this._cacheKey_);
    if (!this.cache || !cache_data) {
      _juiTools2.default.sessionStorage.delete(this._cacheKey_);
    ...
    var throttleDeFn = _juiTools2.default.throttle(function () {
      _this.getItemData();
    }, 260);

    if (this.scrollTrigger) {
      (0, _jquery2.default)(window).off('scroll.home').on('scroll.home', function () {
        throttleDeFn();
      });
    }
  },
  methods: {
    getItemData: function getItemData() {
      ...
      var l_timer = setTimeout(function () {
        ...
        _this2.jqueryLoader && _this2.jqueryLoader.abort();
      }, 10000);
      ...
      this.jqueryLoader = _jquery2.default.get(this.url, _jquery2.default.extend(true, this.extData, {
        ...
        replayDate = _this2.resultCallback(replayDate);
        ...
        if (replayDate.resultCode == 0) {
          ...
          //没有数据
          if (!_this2.item_data.length && !replayDate.result.length) {
            _this2.nodata = true;
          }
          if (replayDate.result.length < _this2.size) {
            _this2.nomore = true;
          }

          _this2.new_limit = replayDate.limit;
          _this2.item_data = _this2.item_data.concat(replayDate.result);
          if (!_this2.cache) {
            //缓存数据
            _this2._cacheData_ = {
              limit: _this2.new_limit,
              data: _this2.item_data,
              loading: _this2.loading,
              nodata: _this2.nodata,
              nomore: _this2.nomore
            };
            _juiTools2.default.sessionStorage.set(_this2._cacheKey_, _this2._cacheData_);
          }
          if (!_this2.nomore && !_this2.nodata) {
            if (_this2.scrollTrigger && gh + (0, _jquery2.default)(window).scrollTop() < loadMoreObj.offset().top) {
              _this2.getItemData();
            }
          }
        } else {}
  ...
  beforeDestroy: function beforeDestroy() {
    (0, _jquery2.default)(window).off('scroll.home');
  }
};
